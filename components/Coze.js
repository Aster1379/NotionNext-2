...
export default function Coze() {
  ...
  const loadCoze = async () => {
    ...
    const CozeWebSDK = window?.CozeWebSDK if (CozeWebSDK) {
      const cozeClient = new CozeWebSDK.WebChatClient({ config: { bot_id: botId }, componentProps: { title: title } })
